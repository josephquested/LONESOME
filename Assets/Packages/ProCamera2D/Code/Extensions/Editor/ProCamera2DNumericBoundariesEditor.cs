...
namespace Com.LuisPedroFonseca.ProCamera2D
{
	...
	public class ProCamera2DNumericBoundariesEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			// Soft boundaries
			_tooltip = new GUIContent("Use Soft Boundaries", "If enabled, the camera movement will ease out at the boundaries instead of instantly stopping.");
			...
			_tooltip = new GUIContent("Soft Area Size", "The distance from the boundary from which the camera will start easing out the movement");
